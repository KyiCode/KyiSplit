...
vi.mock("../utils/currencyServices", async importOriginal => {
    const actual = await importOriginal<
        typeof import("../utils/currencyServices")
    >()
    return {
        ...actual,
        getFxQuote: vi.fn()
...
import { FxUnavailableError, getFxQuote } from "../utils/currencyServices"
import { getExpenses, getGroupDetails } from "../utils/queries"
